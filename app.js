...
const products = [
  ...
  { id: 8,  name: 'Banginpalli',         category: 'kotha-kayalu', origin: 'Narsapur, Andhra Pradesh', desc: 'GI-tagged variety with golden-yellow skin, fibreless pulp, and a mild sweet taste. Perfect for eating fresh.', price: 70, size: '1 kg box', badge: null, images: ['images/products/banginpalli-1.jpg','images/products/banginpalli-2.jpeg'] },
  ...
  const footer = product.soldOut
    ...
    : qty > 0
      ...
      : `<div>
          ...
          <div style="font-size:.72rem;color:#888;margin-top:2px;">Min. 5 kg · Shipping displayed at checkout</div>
        </div>
